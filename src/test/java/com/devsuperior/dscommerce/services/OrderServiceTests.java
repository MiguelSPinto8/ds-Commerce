...
public class OrderServiceTests {
	...
	private Long existingOderId, nonExistingOrderId;
	private Order order;
	...
	void setUp() throws Exception{
		...
		Mockito.when(repository.findById(existingOderId)).thenReturn(Optional.of(order));
	...
	public void findByIdShouldReturnOrderDTOWhenIdExistsAndAdminLogged() {
		...
		OrderDTO result = service.findById(existingOderId);
		
		Assertions.assertNotNull(result);
		Assertions.assertEquals(result.getId(), existingOderId);
